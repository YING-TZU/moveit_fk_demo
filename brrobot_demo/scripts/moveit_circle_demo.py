...
class MoveItCircleDemo:
    def __init__(self):
        ...
        #target_pose.pose.position.x = 0.0714060559215
        #target_pose.pose.position.y = -0.365533695148
        #target_pose.pose.position.z = -0.024996938165
        #target_pose.pose.orientation.x = 0.186244069727
        #target_pose.pose.orientation.y = 0.396455336688
        #target_pose.pose.orientation.z = -0.172151766222
